                ...
                <div class="relative">
                    ...
                    <div className="max-w-[800px] mx-auto shadow-[0_15px_35px_rgba(50,50,93,0.1),_0_5px_15px_rgba(0,0,0,0.07)] rounded-3xl  -mt-[130px] z-40 p-8 ">
                        ...
                        <div className="flex justify-center md:justify-between ">
                            ...
                            <div className="">
                                <div className="rounded-full w-full ">
                                    <Image src={user?.image || "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTtuphMb4mq-EcVWhMVT8FCkv5dqZGgvn_QiA&s"} height={192} width={192} alt='user' className='rounded-full h-[192px] w-[192px] object-cover shadow-xl' />
                                </div>
                            </div>
                            <Link href={'/messenger'} className="hidden md:flex items-center gap-x-2 justify-between pt-32 cursor-pointer">
                        ...
                        <div className="flex flex-col justify-center items-center mt-6 text-gray-600">
                            ...
                            {/* Button */}
                            <Link href={'/messenger'} className=' mx-auto py-2 px-6 rounded-full text-white font-semibold mt-8'><button className='button'>Message</button></Link>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-col-reverse md:flex-row gap-4 justify-center ">
                <div className="min-w-[400px]">
                    <div className="max-w-md mx-start mt-6 bg-white shadow-lg rounded-lg overflow-hidden transform  transition-transform duration-300">
                        <div className="p-4">
                            <h2 className="text-2xl font-bold text-start text-[--color-secondary]  mb-2">My All Events</h2>
                            <div>
                                {
                                   eventLoading ? <Loading></Loading> : myEvents?.length < 1 ? <h5 className='font-bold text-center my-8'>You Have Not Publish Any Events</h5> : myEvents?.slice(0,7)?.map(event => <CardForEvents key={event?._id} event={event}></CardForEvents>)
                                }
                            </div>
                        </div>
                    </div>
