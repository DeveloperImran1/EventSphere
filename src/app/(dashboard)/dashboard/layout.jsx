        ...
        <>
            <div className="min-h-screen bg-gray-100">
                ...
                <div className="flex flex-col md:flex-row gap-4 p-4 pt-[90px] ">
                    {/* Sidebar */}
                    {/* <div className={`${showSidebar ? 'block': 'hidden'}  md:flex fixed h-full w-full z-50`}> */}
                    <div className={`${showSidebar ? 'left-0 top-[77px] md:top-[90px]': '-left-[500px] md:left-0 '}  absolute  h-full w-full z-50 duration-300 `}>
                        <div className='fixed'>
                        <DashboardSideBar />
                        </div>
                    </div>
