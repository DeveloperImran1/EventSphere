...
const UserManage = () => {
  ...
  const handleBlock = async (userId) => {
    try {
        const response = await axios.put(`process.env.https://event-sphare-server.vercel.app/blockedUser/${userId}`,{
            block: true,
        });
  ...
  const fetchUsers = async () => {
    try {
      const response = await axios.get("process.env.https://event-sphare-server.vercel.app/user");
