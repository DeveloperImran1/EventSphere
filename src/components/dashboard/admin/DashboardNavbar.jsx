...
const DashboardNavbar = () => {
    return (
        <header className="  flex flex-col md:flex-row items-center justify-between  bg-gray-200 text-slate-600 py-4 px-4 md:px-6 md:shadow-lg space-y-4 md:space-y-0">
