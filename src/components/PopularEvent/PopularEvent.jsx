...
const CountdownUnit = ({ value, label }) => (
  <div className="flex  gap-1 md:gap-2 items-center justify-center p-1 bg-gradient-to-br from-blue-500 to bg-green-800 rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300">
  ...
  return (
    <div className="flex flex-col items-center space-y-2">
      ...
      <div className="w-full h-1 bg-gray-200 rounded-full overflow-hidden">
        <div
          className="h-full bg-[#1b85db] transition-all duration-1000 ease-linear"
