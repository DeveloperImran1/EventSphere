...
const CountdownUnit = ({ value, label }) => (
  <div className="flex  gap-1 md:gap-2 items-center justify-center p-1 bg-gradient-to-br from-blue-500 to bg-cyan-300 rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300">
