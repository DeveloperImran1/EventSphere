...
const GetTouchSection = () => {
    return (
        <div className='pt-20 md:pt-[130px] test-[16px] text-[#dbe2fb] leading-[18px] bg-[#001232] overflow-x-hidden font-normal'>
            {/* Content Container */}
                ...
                <div className="w-full px-4 mx-auto  lg:max-w-[960px] xl:max-w-[1170px]">
                    <div className="flex flex-col md:flex-row flex-wrap -mx[15px] !justify-between">
                        <div className="w-full md:w-1/2 px-4 md:max-w-[58.333333%] lg:max-w-1/2 xl:max-w-[41.666667%]">
                            ...
                            <from className="-mb-[25px]">
                                {/* from group */}
                                <div className="mb-[25px]">
                                    <label for="name" className='cursor-pointer inline-block mb-2 text-[17px]'>Name <span className='text-[#f1481f] text-[20]'>*</span></label>
                                ...
                                {/* from group */}
                                <div className="mb-[25px]">
                                    <label for="email" className='cursor-pointer inline-block mb-2 text-[17px]'>Email <span className='text-[#f1481f] text-[20]'>*</span></label>
                                ...
                                {/* from group */}
                                <div className="mb-[25px]">
                                    <label for="message" className='cursor-pointer inline-block mb-2 text-[17px]'>Message <span className='text-[#f1481f] text-[20]'>*</span></label>
                                    <input placeholder='Enter Your Message' spellcheck="false" name='message' required
