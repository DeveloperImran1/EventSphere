    ...
    return (
        <div className='mb-20 mt-20'>
            <div className='text-center mx-5 lg:w-2/3 lg:mx-auto '>
                ...
                <h1 className='text-2xl lg:text-5xl font-bold mb-4 leading-tight max-w-2xl mx-auto'>Reduce Stress By Over 50%  With  Eventifys  Powerful  ALL-IN-ONE Event  Management Software </h1>
