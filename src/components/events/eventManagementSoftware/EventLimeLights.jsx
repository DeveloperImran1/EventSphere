        ...
        <section className=' w-11/12 mx-auto'>
            ...
            <article>
                ...
                <div className='flex lg:flex-row-reverse flex-col gap-12'>
                    ...
                    {/* Right Image */}
                    <div className='flex-1'>
                        <Image src="https://img.freepik.com/free-vector/medical-booking-app_23-2148562337.jpg?t=st=1726928764~exp=1726932364~hmac=0a4d6c4d9d36d700abc7f5e1547b6b11777a9eb029ae3f32144e8da001236c80&w=740"
                            alt="register"
                            height={500}
                            width={500}
                            layout='responsive'
            ...
            <article>
                ...
                <div className='flex lg:flex-row flex-col gap-12'>
                    ...
                    {/* Right Image */}
                    <div className='flex-1'>
                        <Image src="https://img.freepik.com/free-photo/appointment-agenda-reminder-personal-organizer-calendar-concept_53876-13792.jpg?t=st=1726938133~exp=1726941733~hmac=5e963d76bb7a9393bed4c7b94dd4998b0326b0ac026912e9c15cfae6d22f8f1b&w=740"
                            alt="register"
                            height={500}
                            width={500}
                            layout='responsive'
            ...
            <article className='mb-20'>
                ...
                <div className='flex lg:flex-row-reverse flex-col gap-6 lg:gap-12'>
                    ...
                    <div className='flex-1 bg-[#E7E8FF] pt-10 px-6 rounded-t-lg'>
                        <Image src="https://cdn.prod.website-files.com/61cee5eb4d566d3471eca114/65c396d2b749951d9e9e513d_User%20Group%20Permissions%20(1).svg"
                            alt="register"
                            height={500}
                            width={500}
                            layout='responsive'
