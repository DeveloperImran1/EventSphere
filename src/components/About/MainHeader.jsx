        ...
        <div className="w-full px-4 mx-auto sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1170px] relative z-[1]">
            <div className="text-center text-white">
                <div className="flex flex-col items-center justify-center p-3 mb-4 max-w-2xl mx-auto">
                    <h2 data-aos="fade-right" className="text-blue-500 text-3xl lg:text-5xl mb-4">
                    ...
                    <button data-aos="fade-right" className="bg-blue-500 py-2 px-6 mt-4 rounded-md hover:bg-blue-600 transition duration-300">
                        Explore More
                    </button>
                </div>
            </div>
